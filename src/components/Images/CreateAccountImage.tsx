...
const CreateAccountImage = () => {
    return (
        ...
        >
            ...
            <ellipse cx="929.5" cy="73.5" rx="17.5" ry="8.5" fill="#4ce096" />
            <ellipse cx="979.5" cy="120.5" rx="17.5" ry="8.5" fill="#4ce096" />
            <ellipse cx="1014.5" cy="120.5" rx="17.5" ry="8.5" fill="#4ce096" />
        </svg>
    )
}
