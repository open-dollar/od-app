...
export function getLTVRatio(totalCollateral, collateralPrice, totalDebt, debtPrice) {
...
export const getCollateralRatio = (totalCollateral, totalDebt, liquidationPrice, liquidationCRatio) => {
...
export const getLiquidationPrice = (totalCollateral, totalDebt, liquidationCRatio, currentRedemptionPrice) => {
    if (Number(totalCollateral) === 0) {
        return '0'
    } else if (Number(totalDebt) === 0) {
        return '0'
